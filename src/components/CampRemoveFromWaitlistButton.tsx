...
import type { CampWaitlistEntry, Climber } from '@prisma/client'
import { useState } from 'react'
import { useRemoveFromCampWaitlist } from '../hooks/waitlist-hooks/useRemoveFromCampWaitlist'

type Props = {
  entry: CampWaitlistEntry & { climber: Climber }
  gymName: string
}

export const CampRemoveFromWaitlistButton = ({ entry, gymName }: Props) => {
  const removeFromWaitlist = useRemoveFromCampWaitlist({ gymName })
